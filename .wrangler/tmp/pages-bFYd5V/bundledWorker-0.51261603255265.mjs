...
function Ie() {
  ...
  return new Proxy(globalThis, { get: /* @__PURE__ */ __name((t, r) => e.has(r) ? e.get(r) : Reflect.get(globalThis, r), "get"), set: /* @__PURE__ */ __name((t, r, s) => Ne.has(r) ? Reflect.set(globalThis, r, s) : (e.set(r, s), true), "set") });
}
__name(Ie, "Ie");
 ...
 * MIT Licensed
 */
//# sourceMappingURL=bundledWorker-0.51261603255265.mjs.map
